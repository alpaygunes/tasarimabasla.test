...
<script>
    ...
    <!--   Dragable -->
    <script src="catalog/view/javascript/kendin_tasarla_onyuz/jquery-ui.js"></script>

    <!-- resize için gerkli -->
    <link rel="stylesheet" href="catalog/view/javascript/kendin_tasarla_onyuz/jquery-ui.css">

    <!--   resizable
    <script src="catalog/view/javascript/jquery-ui-rotatable-master/jquery.ui.rotatable.js"></script>
    <link rel="stylesheet" href="catalog/view/javascript/jquery-ui-rotatable-master/jquery.ui.rotatable.css">
    -->

    <!--   dokunmatik ekranlar için -->
    <script src="catalog/view/javascript/kendin_tasarla_onyuz/jquery.ui.touch-punch.min.js"></script>

    <!-- image exif oryantasyon için -->
    <!-- <script type="text/javascript" src="catalog/view/javascript/kendin_tasarla_onyuz/JavaScript-Load-Image-master/js/load-image.all.min.js"></script> -->

    <script type="text/javascript" src="catalog/view/javascript/kendin_tasarla_onyuz/kendin_tasarla_onyuz.js"></script>
    <script type="text/javascript" src="catalog/view/javascript/kendin_tasarla_onyuz/content_render_onyuz.js"></script>
    <script type="text/javascript" src="catalog/view/javascript/kendin_tasarla_onyuz/curve_text.js"></script>
    <script type="text/javascript" src="catalog/view/javascript/kendin_tasarla_onyuz/resim_ekleme_onyuz.js"></script>
    <script type="text/javascript" src="catalog/view/javascript/kendin_tasarla_onyuz/kirpici.js"></script>

    <link rel="stylesheet" href="catalog/view/theme/default/stylesheet/kendin_tasarla_onyuz.css"  rel="stylesheet" media="screen" />

    <!--   dokunmatik ekranlar icin -->
    <script src="catalog/view/javascript/kendin_tasarla_onyuz/jquery.ui.touch-punch.min.js"></script>
    <!-- ------------------------------------------------------------------- -->


    <!--   istatistik ekranlar icin -->
    <script type="text/javascript" src="catalog/view/javascript/resimli_secenek.js"></script>
    <!-- ------------------------------------------------------------------- -->


<script>

    var site_adi = "<?php echo HTTP_SERVER;?>"
    $(document).ready(function() {
        console.log(site_adi);
        //---------------------- alpaygunes -------------- önceden sepet doluysa
        $('#cart-total').click(function () {
            var str = $('#cart-total').html();
            var res = str.split(" ");
            if(res[0]!='0'){
                window.location.href =site_adi+"index.php?route=checkout/cart";
            }
        })

        // fare üzerine gelince görünmesin
        $('.journal-cart #cart .content').hide();
...
<!-- Global site tag (gtag.js) - Google AdWords: 1001465216 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1001465216"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-1001465216');
</script>
